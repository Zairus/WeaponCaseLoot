...
public class WCLItem extends Item
{
	...
	public static ItemStack loop(ItemStack stack, String loopName, String soundName, int[] rarity_array, World world, Entity entity, int iconMin, int iconMax)
	{
		if (stack.hasTagCompound())
		{
			...
			if (tag.hasKey(WCLConstants.KEY_LOOPSOUNDTIMER))
			{
				...
				if (t <= 10.0F)
				{
					...
					world.playSoundAtEntity(entity, "weaponcaseloot:" + soundName, 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + 0.5F);
				}
			}
		}
